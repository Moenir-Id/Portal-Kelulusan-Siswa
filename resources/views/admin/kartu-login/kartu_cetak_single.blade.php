...
<head>
    <meta charset="UTF-8">
    <title>Kartu Login — {{ $akuns->first()->siswa->nama }}</title>
...
<div class="toolbar">
    ...
    <button class="tb-btn tb-ghost" onclick="window.close()">✕ Tutup</button>
    <span class="tb-info">🪪 Kartu Login — {{ $akuns->first()->siswa->nama }}</span>
</div>
            ...
            <div class="kartu-wrap">
                <div class="kartu">
                    ...
                    <div class="kartu-footer">
                        <div class="kf-kiri">
                            <div class="kf-nisn">NISN: {{ $siswa->nisn }}</div>
