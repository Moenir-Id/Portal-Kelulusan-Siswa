...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* ── CSS sama persis dengan surat.blade.php ── */
        ...
        .kop-text .nama-sekolah  { font-size: 16pt; font-weight: 900; letter-spacing: .04em; text-transform: uppercase; margin: 2px 0; }
        ...
        .status-kelulusan {
            text-align: center !important; font-size: 23px; font-weight: 900;
            margin: 15px auto; letter-spacing: .15em; text-transform: uppercase;
            border: 1.5px solid #000; width: fit-content; padding: 5px 30px;
        }
...
@php
    ...
    $tahunPelajaran = $pgTahun ?: ($tahunLulus . '/' . (intval($tahunLulus) + 1));
@endphp
<div class="halaman">
    ...
    <div class="isi">
        ...
        <p>
            dari satuan pendidikan <strong>{{ strtoupper($sekolahNama ?: 'sekolah ini') }}</strong> setelah menyelesaikan
